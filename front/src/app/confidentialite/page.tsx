  ...
  return (
      <main className="max-w-3xl mx-auto px-4 py-8">
        ...
        <p>
          ...
          utilisons vos données lors de votre inscription au tournoi.
        </p>
        ...
        <p>
          ...
          <a className="text-blue-600 hover:underline"
             href="mailto:tournoiuskb@gmail.com">
            tournoiuskb@gmail.com
          </a>
        </p>

        <h2 className="text-xl font-semibold mt-6 mb-2">Données collectées</h2>
        <p>
          Nous collectons uniquement les données nécessaires à l&rsquo;inscription :
          nom,
          prénom, email, téléphone, licence FFTT.
        </p>

        <h2 className="text-xl font-semibold mt-6 mb-2">Utilisation des données</h2>
        <p>
          Vos données servent exclusivement à la gestion du tournoi et ne sont pas
          partagées avec des tiers.
        </p>

        <h2 className="text-xl font-semibold mt-6 mb-2">Hébergement des données</h2>
        <p>
          Vos données sont hébergées par Amazon Web Services (AWS), dans la région
          &quot;eu-west-3&quot; (Paris, France). AWS garantit un haut niveau de sécurité
          et de conformité avec le RGPD.
        </p>

        <h2 className="text-xl font-semibold mt-6 mb-2">Paiement sécurisé</h2>
        <p>
          Les paiements sont traités via Stripe. Aucune donnée bancaire n&rsquo;est
          stockée
          par l&rsquo;USKB.
        </p>
        ...
        <p>
          Vos données sont conservées jusqu&apos;à la fin du tournoi et archivées pour
          une
        ...
        <p>
          Conformément au RGPD, vous pouvez accéder, rectifier ou supprimer vos données
