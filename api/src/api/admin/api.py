...
from api.shared.api.custom_decorators import after_cutoff
...
from api.shared.api.dependencies import get_rw_session, get_ro_session, GenSession
...
@api_router.route("/players/<licence_no>")
...
@api_router.post("/players/<licence_no>")
...
@api_router.post("/entries/<licence_no>")
...
@api_router.delete("/players/<licence_no>")
...
@api_router.put("/bibs/<licence_no>")
@after_cutoff
